...
public class FreeCubeTwoGamePiece extends SequentialCommandGroup {
  ...
  public FreeCubeTwoGamePiece(DriveSubsystem drivebase, EndEffectorIntake m_intake, LiftArm m_arm, Field2d m_field, StateManager m_manager, Vision m_vision, AutoSelector m_autoSelector, Wrist wrist ) {
