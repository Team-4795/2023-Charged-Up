...
public class CubeTwoGamePiece extends SequentialCommandGroup {

public CubeTwoGamePiece(DriveSubsystem drivebase, EndEffectorIntake m_intake, LiftArm m_arm, Field2d m_field,
